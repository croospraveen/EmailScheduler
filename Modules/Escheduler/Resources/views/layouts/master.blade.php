...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('public/template/dist/css/skins/skin-blue.min.css') }}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Email</b>TASK</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li ><a href="{{ route('loadmanager')}}"><i class="fa fa-link"></i> <span>Emails Manager</span></a></li>
        <li class="active"><a href="{{ route('loadscheduler')}}"><i class="fa fa-bar-chart-o"></i> <span>Email Scheduler</span></a></li>
...
<script src="{{ asset('public/template/dist/js/adminlte.min.js') }}"></script>
 ...
 <script>
...

    {
       ...
       $('#sendmaildate').val(today);

      $("#sendmaildate").datepicker();
            ...
            $.ajaxSetup({
              ...
              for (instance in CKEDITOR.instances) {
               ...
               // var formdata = $(this).serialize();
                 var alias = $("#emailalias").val();
                 var subject = $("#emailsubject").val();
                 var body =  CKEDITOR.instances['emailbody'].getData();
                 var batches = [];
                    $.each($("input[name='emailbatch']:checked"), function(){
                    batches.push($(this).val());
                });
                var formData = new FormData($("#ssmail")[0]);
                formData.append('body', body);
              
                $.ajax({
                    url:"escheduler/sendmail",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
