  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{ route('loadmanager')}}"><i class="fa fa-link"></i> <span>Emails Manager</span></a></li>
        <li><a href="{{ route('loadscheduler')}}"><i class="fa fa-bar-chart-o"></i> <span>Email Scheduler</span></a></li>
